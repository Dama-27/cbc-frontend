        ...
        <div className=" w-full h-full flex">
          ...
          <div className="w-[50%] h-full flex justify-center items-center">
            <div className="w-[500px] h-[500px] flex flex-col items-center">
              ...
              {/* product id */}
              <h2 className="w-full text-center my-2 text-gray-600 mt-2">
                {product.productId}
              </h2>
              <p className="w-full text-center my-2 text-gray-600 mt-2">
                {product.description}
              </p>
              ...
              <div className="w-full flex justify-center">
                <button
                  className="w-1/2 h-12 mx-4 cursor-pointer bg-accent text-white font-semibold rounded-md hover:bg-secondary"
                  onClick={() => {
